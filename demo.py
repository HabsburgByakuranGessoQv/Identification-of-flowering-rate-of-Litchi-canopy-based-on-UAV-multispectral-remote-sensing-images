...
#     # ----------------------------------------------------------------------------------------------------------------------------#
#     model_path = r"E:\STUDYCONTENT\Pycharm\classification-pytorch-main\model_data\99.25_res_zz.pth"
#     # ------------------------------------------------------#
...
#     target_path = r'D:\APPDATAiD\aliyunpan\moxing\\'
...
#     for i in range(9):
#         img = cv2.imread('E:\STUDYCONTENT\Pycharm\classification-pytorch-main\img\99_0220.jpg')
#         title = "title" + str(i + 1)
#         # 行，列，索引
#         plt.subplot(3, 3, i + 1)
#         plt.imshow(img)
...
clas = ['0%', '10%~30%', '40%~70%', '>80%']
plt.rc("font", family='Microsoft YaHei')
imgpath = r'E:\STUDYCONTENT\Pycharm\classification-pytorch-main\img'
lv = os.listdir(imgpath)
plt.figure(figsize=(18, 18))
for i in range(len(lv)):
    img_p = os.path.join(imgpath, lv[i])
    pic = os.listdir(img_p)
    for j in range(len(pic)):
        pic_p = os.path.join(img_p, pic[j])
        img = cv2.imread(pic_p, -1)
        img = img[:, :, ::-1]
        name = r'Actual:{} Predict:{}'.format(clas[i], clas[i])
        plt.subplot(3, 3, 2*i+1+j)
        plt.imshow(img)
        plt.xlabel(str(pic[j])[:-3]+'tif', fontsize=16)
        plt.title(name, fontsize=16)
        # plt.xticks([])
        # plt.yticks([])
img1 = r'D:\APPDATAiD\aliyunpan\CanopyFinal\RGB\0%\78_0301.jpg'
img = cv2.imread(img1, -1)
img = img[:, :, ::-1]
name = r'Actual:0% Predict:10~30%'
plt.subplot(3, 3, 9)
plt.imshow(img)
plt.xlabel('78_0301.tif')
