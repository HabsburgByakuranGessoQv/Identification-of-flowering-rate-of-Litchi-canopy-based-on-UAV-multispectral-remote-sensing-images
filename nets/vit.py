...
class PatchEmbed(nn.Module):
    def __init__(self, input_shape=[224, 224], patch_size=16, in_chans=5, num_features=768, norm_layer=None,
                 flatten=True):
        super().__init__()
...
class VisionTransformer(nn.Module):
    def __init__(
            self, input_shape=[224, 224], patch_size=16, in_chans=6, num_classes=1000, num_features=768,
